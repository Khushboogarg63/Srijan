...
public class EventsActivity2 extends ListActivity {
        ...
        private void updateUI(){
            try {
                ...
                for (int r = 0; r < rows.length(); r++) {
                    ...
                    //int losses = columns.getJSONObject(5).getString("v");
                    //int points = columns.getJSONObject(19).getString("v");
            ...
            ListAdapter adapter = new SimpleAdapter(
                    EventsActivity2.this, eventsList,
